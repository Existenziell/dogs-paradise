export const urls = [
  {
    ...
    url: '/',
    icon:
      <svg className='w-10 sm:w-16' fill='currentColor' viewBox="0 0 63.445 63.445" stroke="currentColor" strokeWidth={1} xmlns="http://www.w3.org/2000/svg" >
        <g>
          <g>
  ...
  {
    name: 'N2', url: '/services', icon:
      <svg className="w-10 sm:w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} xmlns="http://www.w3.org/2000/svg" >
