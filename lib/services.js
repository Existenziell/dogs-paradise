export const services = [
  ...
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p><span className="">Small dog 1h:</span> 150 (Members: 100)</p>
        <p><span className="">Big dog 1h:</span> 200 (Members: 150)</p>
        <p><span className="">Small dog 2h:</span> 250 (Members: 200)</p>
        <p><span className="">Big dog 2h:</span> 300 (Members: 250)</p>
      </div>,
    isNew: false
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p className="">Small dog:<span> 350 (Members: 280)</span></p>
        <p className="">Big dog 1h:<span> 400 (Members: 300)</span></p>
      </div>,
    isNew: false
  },
  {
  ...
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p><span className="">Small dog 4h:</span> 250 (Members: 180)</p>
        <p><span className="">Big dog 4h:</span> 250 (Members: 200)</p>
        <p><span className="">Small dog 8h:</span> 270 (Members: 220)</p>
        <p><span className="">Big dog 8h:</span> 300 (Members: 250)</p>
      </div>,
    isNew: false
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p><span className="">Normal:</span> 100</p>
        <p><span className="">Members:</span> 50</p>
      </div>,
    isNew: false
  },
  {
  ...
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p><span className="">Normal:</span> 200</p>
        <p><span className="">Members:</span> 1 free per month!</p>
      </div>,
    isNew: false
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p><span className="">Normal:</span> 200</p>
        <p><span className="">Members:</span> Free</p>
      </div>,
    isNew: false
  },
  {
    ...
    prices:
      <div className="flex flex-col gap-1">
        <p><span className="">Normal:</span> 500</p>
        <p><span className="">Members:</span> 400</p>
      </div>,
    isNew: false
  },
]
